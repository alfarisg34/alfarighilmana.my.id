...
## Users
Technical recruiters, engineering managers, CTOs/tech leads, and enterprise clients evaluating senior fullstack engineering, systems architecture, multimodal AI pipelines, and mission-critical automation capabilities.
...
- Deployed on Vercel Edge with custom DNS (`alfarighilmana.my.id`) via Hostinger.

## Capabilities and Constraints
- **Stack**: Semantic HTML5, Vanilla CSS3 (Anti-Template UI design system: `style.css`, `components.css`, `responsive.css`), Vanilla JavaScript (`app.js`, `data.js`, `icons.js`).
- **Zero Heavy Framework Runtime**: Ultra-fast load times, edge-ready static delivery, zero frontend bundle bloat.
- **Interactive Deep Dives**: Multi-layer project modals, ASCII architecture schemas, category filtering with live counters (`[00] ALL (7)`, `[01] ENTERPRISE (1)`, `[02] AI & OCR (3)`, `[03] CANVAS (1)`, `[04] FULLSTACK (1)`, `[05] SDET (1)`), telemetry nodes console, and instant clipboard triggers.
- **Performance & Responsiveness**: Fluid mobile/tablet layouts, Dark Cockpit / Light Spec Sheet theme toggle, noise/gridline backdrops, WCAG AA high contrast.

## Brand Commitments
- **Name**: Alfari Sidnan Ghilmana (short: Alfari)
- **Domain**: `alfarighilmana.my.id`
- **Profiles**: GitHub (`alfarisg34`), LinkedIn (`alfari-ghilmana`), Email (`alfari.ghilmana@gmail.com`), WhatsApp (`+62 812-9042-3000`)
- **Tone & Voice**: Authoritative, precise, technically rigorous, professional, and clear.
...
6. **Smart Financial & Budget Intelligence Platform**: Fullstack Wealth OS with in-line mathematical evaluation (`https://financialdashboard.alfarighilmana.my.id/`).
7. **ConnectHub LMS — SDET & Automated QA Architecture**: Playwright POM test framework, SQLi/XSS resilience fuzzing, 100-batch stress test runner.
